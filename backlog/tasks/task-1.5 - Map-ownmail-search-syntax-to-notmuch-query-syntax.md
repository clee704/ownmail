...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 from:/subject:/date:/label: map to notmuch equivalents
- [ ] #2 attachment: has no notmuch equivalent - implement via tag-on-ingest instead
- [ ] #3 Existing search test cases pass against notmuch backend
<!-- AC:END -->
