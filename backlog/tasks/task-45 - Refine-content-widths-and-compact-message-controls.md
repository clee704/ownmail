...
- [x] #4 Browser checks cover wide desktop and mobile layouts, both themes and reader menu interaction; required repository validation passes.
<!-- AC:END -->
